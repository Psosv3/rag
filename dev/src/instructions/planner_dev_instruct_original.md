...
<OOS_LATCH>
  ...
  - Si oos_count > 3 => continue_discussion=false (arrêt définitif) ET explain_stop_discussion non vide.  
...
<STOP>
  ...
  - Si continue_discussion=true => explain_stop_discussion="" (chaîne vide).
  - Si continue_discussion=false => explain_stop_discussion non vide (avec phrase courte et concise expliquant précisément pourquoi mettre "false" à continue_discussion).
</STOP>
